export default {
  ...
  lianxian: {
    ...
    schemeManager: '方案管理',
    connect: '連線',
    connectDefault: '連線預設方案',
    connectNamed: '連線：{name}',
    disconnect: '中斷連線',
    setDefault: '設為預設',
    default: '預設',
    schemeName: '方案名稱',
    ...
    red: '紅方',
    black: '黑方',
    redOnTop: '紅方在上（對方棋盤翻轉）',
    pollInterval: '辨識間隔（毫秒）',
    clickDelay: '點擊間隔（毫秒）',
    titleFilter: '視窗標題包含（可選）',
    window: '目標視窗',
    boardPoints: '棋盤校準點',
    extraClicks: '額外點擊點',
    extraClick: '額外點擊',
    addExtraClick: '新增額外點擊（按 Ctrl 取點）',
    pressCtrlExtra: '請把滑鼠移到按鈕上，再按 Ctrl',
    recalibrate: '重新校準棋盤',
    editScheme: '編輯方案',
    newScheme: '新方案',
    noScheme: '還沒有連線方案，請先建立。',
    windowsOnly: '連線目前僅支援 Windows 桌面版。',
    windowSizeMismatch: '目標視窗大小與方案不一致，請不要縮放對方棋盤。',
    windowChanged: '兩次取點不在同一個視窗，請重試。',
    needEngine: '請先載入引擎，才能自動出招。',
    calibrateTitle: '建立連線方案',
    calibrateTopLeft: '請把滑鼠移到對方棋盤左上角黑車中心，然後按 Ctrl。',
    calibrateBottomRight: '請把滑鼠移到對方棋盤右下角紅車中心，然後按 Ctrl。',
    calibrateHint: '對方視窗保持在前景。Esc 或取消可中止。開局未走動時校準最準。',
    calibrateDone: '校準完成，請儲存方案。',
    statusConnecting: '正在連接「{name}」…',
    statusSyncing: '正在同步棋盤…',
    statusWatching: '等待對方走子',
    statusThinking: '引擎思考中',
    statusClicking: '正在點擊走子 {move}',
    statusPlayed: '已走出 {move}',
    statusOpponentMoved: '對方走了 {move}',
    statusResynced: '局面已重新同步',
    statusUnstable: '辨識不穩定，正在確認…',
