export default {
  ...
  lianxian: {
    ...
    schemeManager: '方案管理',
    connect: '连线',
    connectDefault: '连线默认方案',
    connectNamed: '连线：{name}',
    disconnect: '断开连线',
    setDefault: '设为默认',
    default: '默认',
    schemeName: '方案名称',
    ...
    red: '红方',
    black: '黑方',
    redOnTop: '红方在上（对方棋盘翻转）',
    pollInterval: '识别间隔（毫秒）',
    clickDelay: '点击间隔（毫秒）',
    titleFilter: '窗口标题包含（可选）',
    window: '目标窗口',
    boardPoints: '棋盘校准点',
    extraClicks: '额外点击点',
    extraClick: '额外点击',
    addExtraClick: '添加额外点击（按 Ctrl 取点）',
    pressCtrlExtra: '请把鼠标移到按钮上，再按 Ctrl',
    recalibrate: '重新校准棋盘',
    editScheme: '编辑方案',
    newScheme: '新方案',
    noScheme: '还没有连线方案，请先创建。',
    windowsOnly: '连线目前仅支持 Windows 桌面版。',
    windowSizeMismatch: '目标窗口大小与方案不一致，请不要缩放对方棋盘。',
    windowChanged: '两次取点不在同一个窗口，请重试。',
    needEngine: '请先加载引擎，才能自动出招。',
    calibrateTitle: '创建连线方案',
    calibrateTopLeft: '请把鼠标移到对方棋盘左上角黑车中心，然后按 Ctrl。',
    calibrateBottomRight: '请把鼠标移到对方棋盘右下角红车中心，然后按 Ctrl。',
    calibrateHint: '对方窗口保持在前台。Esc 或取消可中止。开局未走动时校准最准。',
    calibrateDone: '校准完成，请保存方案。',
    statusConnecting: '正在连接「{name}」…',
    statusSyncing: '正在同步棋盘…',
    statusWatching: '等待对方走子',
    statusThinking: '引擎思考中',
    statusClicking: '正在点击走子 {move}',
    statusPlayed: '已走出 {move}',
    statusOpponentMoved: '对方走了 {move}',
    statusResynced: '局面已重新同步',
    statusUnstable: '识别不稳定，正在确认…',
    statusDisconnected: '已断开连线',
  },
